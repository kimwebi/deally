...
<div class="card" style="max-width:860px;">
    <div class="card-body">
        <form method="POST" action="{{ route('tenant.pages.store', $tenant) }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" id="slug" name="slug" value="{{ old('slug') }}" class="form-control" placeholder="e.g. about-us" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" class="form-control" rows="14" style="font-family:ui-monospace,Menlo,monospace; font-size:13px;">{{ old('content') }}</textarea>
            </div>
